...
class BEAR(Packet.PKT):
    ...
    def print_welcome_msg(self):
        print(r"==============================================================")
        print(r"   __        __          _                               _    ")
        print(r"   \ \      / /___  ___ | |_ __      __ ___    ___    __| |   ")
        print(r"    \ \ /\ / // _ \/ __|| __|\ \ /\ / // _ \  / _ \  / _` |   ")
        print(r"     \ V  V /|  __/\__ \| |_  \ V  V /| (_) || (_) || (_| |   ")
        print(r"      \_/\_/  \___||___/ \__|  \_/\_/  \___/  \___/  \__,_|   ")
        print(r"              ____         _             _    _               ")
        print(r"             |  _ \  ___  | |__    ___  | |_ (_)  ___  ___    ")
        print(r"             | |_) |/ _ \ | '_ \  / _ \ | __|| | / __|/ __|   ")
        print(r"             |  _ <| (_) || |_) || (_) || |_ | || (__ \__ \   ")
        print(r"             |_| \_\\___/ |_.__/  \___/  \__||_| \___||___/   ")
        print(r"                                                              ")
        print(r"==============================================================")
        print(r"=== PyBEAR by Westwood Robotics -- Last Updated 2025.07.29 ===")
        print(r"==============================================================")
        print()
